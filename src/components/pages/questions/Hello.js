...
function Hello({ tools: { setPage }}) {
    return (
        <div className="all-margin hello">
            ...
            <p className="box-paragraph">É só responder às próximas perguntas com sinceridade. A partir das suas respostas vamos te enviar 3 opções incríveis de presentes. Aí só você escolher entre elas e aproveitar a sensação que só um bom presente pode provocar.</p>
