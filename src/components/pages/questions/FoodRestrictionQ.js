            ...
            <div className="all-center">
                <div>
                    ...
                    <div>
                        ...
                        {inRestriction === "tem alergia ou não come de jeito nenhum" && <div className="space-up-down"><input type="text" value={complement} onChange={e => setComplement(e.target.value)} placeholder="Quais?" autoComplete="off"/></div>}
                        
                        <label className="radio-option big-words long-option">
